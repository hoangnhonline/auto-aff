...
<div class="container">
    ...
    <div class="content-popular11">
      <div class="popular-cat-title">
        <ul>
          <li class="active"><a href="#" data-toggle="tab">Tư vấn</a></li>
    ...
    <!-- End Popular Product -->
    <div class="simple-adv11 item-adv-simple">
      <a href="#"><img src="{{ URL::asset('assets/images/home11/ad4.jpg') }}" alt="" /></a>
    </div>
    <!-- End Adv -->
    <div class="content-popular11">
      <div class="popular-cat-title">
        <ul>
          <li class="active"><a href="#" data-toggle="tab">Kinh nghiệm</a></li>
    ...
    <!-- End Popular Product -->
    <div class="simple-adv11 item-adv-simple">
      <a href="#"><img src="{{ URL::asset('assets/images/home11/ad5.jpg') }}" alt="" /></a>
    </div>   
</div>
@endsection
@section('javascript')
