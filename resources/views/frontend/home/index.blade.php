          ...
          <div class="item col-md-2">
            <div class="item-product5">
              <div class="product-thumb product-thumb5">
                <a href="https://pub.accesstrade.vn/deep_link/4463492395743736163?url={{ $sp->url }}" target="_blank" class="product-thumb-link">
                  <img class="first-thumb" src="{{ $sp->thumbnail_url }}" alt=""/> 
                  <img class="second-thumb" src="{{ $sp->thumbnail_url }}" alt=""/>                
                </a>
                <div class="product-info-cart">                
                  <a href="https://pub.accesstrade.vn/deep_link/4463492395743736163?url={{ $sp->url }}" target="_blank" class="addcart-link"><i class="fa fa-shopping-basket"></i>  Mua ngay</a>
                </div>
              </div>
              <div class="product-info5">
                <h3 class="title-product"><a href="https://pub.accesstrade.vn/deep_link/4463492395743736163?url={{ $sp->url }}" target="_blank">{{ $sp->name }}</a></h3>
